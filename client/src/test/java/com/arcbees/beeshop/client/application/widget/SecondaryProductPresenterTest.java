...
public class SecondaryProductPresenterTest {
    ...
    private static final Brand BRAND = Brand.CHOSEN;

    @Inject
    private ProductFactory productFactory;
    @Inject
    private SecondaryProductPresenter.MyView view;
    @Inject
    private CurrentBrand currentBrand;
    private SecondaryProductPresenter presenter;

    @Before
    public void setUp() {
        ProductDto dto = new ProductDto();

        presenter = productFactory.create(dto);
    }
